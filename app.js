  ...
  try {
    ...
    if (data && data.length > 0) {
      ...
      if (!isSeeding) {
        ...
        // If it's still empty after trying to seed, or seeding failed, just show empty or defaults
        console.warn("Seeding failed or database is still empty. Falling back to local defaults temporarily.");
