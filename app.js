...
const RANDOM_PROFILES = [
  { name: "Elon Musk", email: `elon${randomSuffix}@tesla.com`, phone: "+1 800 555 1111", avatar: AVATARS[0] },
  { name: "Steve Jobs", email: `steve${randomSuffix}@apple.com`, phone: "+1 800 555 2222", avatar: AVATARS[1] },
  { name: "Bill Gates", email: `bill${randomSuffix}@microsoft.com`, phone: "+1 800 555 3333", avatar: AVATARS[2] },
  { name: "Lionel Messi", email: `messi${randomSuffix}@miami.com`, phone: "+1 800 555 4444", avatar: AVATARS[3] },
  { name: "Michael Jordan", email: `jordan${randomSuffix}@bulls.com`, phone: "+1 800 555 5555", avatar: AVATARS[4] }
];
...
let appState = {
  ...
  theme: "dark",
  activities: [],
  profile: RANDOM_PROFILES[Math.floor(Math.random() * RANDOM_PROFILES.length)],
